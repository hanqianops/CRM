# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-16 03:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.ClassList')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('consult_courses', models.ManyToManyField(to='repository.Course')),
                ('consultant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_consultant', to='repository.Account')),
                ('referral_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_referral', to='repository.Account')),
            ],
            options={
                'verbose_name': '客户信息表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Account')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Customer')),
            ],
        ),
        migrations.CreateModel(
            name='Enrollment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_method', models.SmallIntegerField(choices=[(0, '现金'), (1, '支付宝'), (2, '刷卡')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('menus', models.ManyToManyField(blank=True, null=True, to='repository.Menu')),
            ],
        ),
        migrations.CreateModel(
            name='Source',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Account')),
            ],
        ),
        migrations.CreateModel(
            name='SubMenu',
            fields=[
                ...
                ('url', models.CharField(max_length=128)),
                ('order', models.SmallIntegerField(default=0)),
                ('menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Menu')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            model_name='customer',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Source'),
        ),
        migrations.AddField(
            model_name='customer',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='contract',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Contract'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='course',
        ...
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(to='repository.Account'),
        ),
        migrations.AddField(
            model_name='account',
            name='customer',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='repository.Customer'),
        ),
        migrations.AddField(
            model_name='account',
            name='role',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='repository.Role'),
        ),
        migrations.AlterUniqueTogether(
            name='submenu',
            unique_together=set([('url', 'url_type')]),
